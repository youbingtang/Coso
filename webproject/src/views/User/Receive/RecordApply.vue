            ...
            <form>
                <table style="width: 1000px">
                    <tr >
                        ...
                        <td colspan="4">B/L NO.：<input style="width: 80%" type="text" v-model="form.blNo"/></td>
                    </tr>
                    <tr>
                ...
                <el-select v-model="form.sendCompanyId" placeholder="请选择出单公司" @change="findlogo">
                    <el-option
                ...
                <el-select v-model="form.signatureCompanyId" placeholder="请选择签章公司">
                    <el-option
        ...
        methods: {
            ...
            apply() {
                ...
                if(_this.form.sendCompanyId===''){
                    ...
                    axios.get(this.url+'insertLading',{
                        params:{
            ...
            findlogo(){
                let _this=this;
                axios.get(this.url+'findlogobycid',{
                    params:{
                        cid:this.form.sendCompanyId,
                    }
                }).then(function (data) {
