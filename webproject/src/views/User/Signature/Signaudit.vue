            ...
            <el-dialog title="驳回意见" :visible.sync="dialogFormVisible"
                ...
                <el-col :span="24" class="col1">
                    <div class="ios"style="margin-right: 300px">
                        <p align="right">意见：<el-input type="text" v-model="detailsData.signatureAuditOpinion" auto-complete="off" style="width: 240px" ></el-input></p>
                    </div>
                </el-col>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods:{
            ...
            hanson(){
                let _this = this;
                if (!this.detailsData.signatureAuditOpinion) {
                    this.$message.error('请输入意见')
                }else {
                    axios.get(this.url + 'siunapply', {
                        params: {
                            account: sessionStorage.getItem('account'),
                            blNo: this.blNo,
                            signatureAuditOpinion: this.detailsData.signatureAuditOpinion,
                        }
                    }).then(function (data) {
                        if (data.data === 1) {
                            _this.$message({
