...
public interface LogoMapper {
	 ...
	 * @return 1 logo信息修改成功
	 */
	public int edit(@Param("copanyId") int copanyId, @Param("name") String name, @Param("file") String file,
			@Param("isEnable") int isEnable, @Param("confirmStatus") int confirmStatus, @Param("id") int id);
	/**
	 * 删除logo
	 * @param name:logo名称
	 * @return 1 logo删除成功
